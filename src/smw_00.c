...
// As timer_player_hurt counts down from 127 or 48 to 0, blink frequency accelerates from once every 8 frames up to once per frame (or every two frames to avoid glitch when limited to 30 fps)
#if LIMIT_30FPS != 0
  #define BLINK_EVERY_N_FRAMES 2
#else
  #define BLINK_EVERY_N_FRAMES 1
#endif /* LIMIT_30FPS */
static const uint8 kPlayerGFXRt_DATA_00E292[16] = { BLINK_EVERY_N_FRAMES, BLINK_EVERY_N_FRAMES, BLINK_EVERY_N_FRAMES, BLINK_EVERY_N_FRAMES, 0x2, 0x2, 0x2, 0x2, 0x4, 0x4, 0x4, 0x4, 0x8, 0x8, 0x8, 0x8,  };
